...
<?php
   ...
   $sql="SELECT * FROM gallery GROUP BY title HAVING status=1;";
...
<div class="side-bar">
   <h4 class="heading">filter images</h4>
   <div class="box">
   ...
   <div class="box">
      ...
      <div class="category">
         ...
         <?php
            ...
            {
         ?>
               <div class="btn" data-category="<?php echo $row['title']; ?>"><?php echo $row['title'] ?></div>
         <?php
            }
         ?>
      </div>
...
<div class="gallery">
   ...
   <h1 class="heading">Our School Gallery</h1>
...
include 'connection.php';
                    ...
                    $galary=mysqli_query($con,"SELECT * FROM gallery WHERE status=1");
                    if(mysqli_num_rows($galary)>0)
                    {
                        while($galary_fetch=mysqli_fetch_assoc($galary))
                        {
                            $g_name=$galary_fetch['image'];
                            $Title=$galary_fetch['title'];
                            
                            ?>
       <center><div class="col"><div class="card"><div class="card-body">                     
      <img class="card-img-top img-fluid" src="gallery_img/<?php echo $g_name; ?>" data-cat="<?php echo $Title; ?>" data-search="<?php echo $Title; ?>" width="400" height="400" alt="">
                        </div></div></div></center>
