                ...
                <form action="gallery_upload.php" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="apply" id="mysel" class="form-control" required="require">
                                <option value="" disabled="disabled" selected="selected">Choose Results</option>
                                <option value="1">Image Slider (Crosel)</option>
                                <option value="2">The School Profile</option>
                                <option value="3">About Our School</option> 
                                <option value="4">About Our Principal</option>
                                <option value="5">How to Works It</option>
                            </select>
                        </div>
                                ...
                                <td> <?php echo $row['id']; ?> </td>
                                    ...
                                    <td>
                                        <?php
                                            if ($status=='1')
                                            {
                                                echo"Image Slider (Crosel)";
                                            }
                                            elseif ($status=='2')  
                                            {
                                                echo"The School Profile";
                                            }
                                            elseif ($status=='3')  
                                            {
                                                echo"About Our School";
                                            }
                                            elseif ($status=='4')  
                                            {
                                                echo"About Our Principal";
                                            }
                                            else
                                            {
                                                echo"How to Works It";
                                            }
                                        ?>
                                    </td>
                                    <td> <img class="img-profile " alt="Image" src="index_page_img/<?php echo $row['image'];?>" width="100px" height="100px"> </td>
                                    <td> <?php echo"<a href='gallery_edit.php?uid=$id' class='btn btn-success'>EDIT</a>"?></td>
                                    <td> <?php echo "<a href='gallery_dlt.php?did=$id' class='btn btn-danger btn-md'>DELETE</a>"?></td>
                                </tr>
                        <?php
                            }
                        ?>
