    ...
    <div id='gallery'class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="index_page_upload.php" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <label >Title :</label>
                            <select name="name" id="" class="form-control" required="require">
                                <option value="" disabled="disabled" selected="selected">Choose Results</option>
                                <option value="Image Slider">Image Slider (Crosel)</option>
                                ...
                                <option value="Why You Need to Choose Our School">Why You Need to Choose Our School</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label >Description (Limit 500 Charcters) :</label>
                            <!-- <input class="form-control" type="text" paceholder="Description" autocomplete="off" name="desc" required> -->
                            <textarea name="desc" id="" class="form-control" cols="30" rows="10" maxlength="" ></textarea>
                        </div>

                        <div class="form-group">
                            <label >Image :</label>
                            <input class="form-control" type="File" multiple paceholder="Image" id="img" accept="image/*" name="img[]" required>
                        </div>
                    </div>
                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                <td> <?php echo $row['id']; ?> </td>
                                    ...
                                    <td> <img class="img-profile " alt="Image" src="index_page_img/<?php echo $row['image'];?>" width="100px" height="100px"> </td>
                                    <td> <?php echo"<a href='index_page_edit.php?uid=$id' class='btn btn-success'>EDIT</a>"?></td>
                                    <td> <?php echo "<a href='index_page_dlt.php?did=$id' class='btn btn-danger btn-md'>DELETE</a>"?></td>
                                    <td>
                                        <?php
                                            if ($status=='1')
                                            {
                                                echo"<a href='index_page_update.php?uid=$id' class='btn btn-md btn-success'>Show</a>";
                                            }
                                            else
                                            {
                                                echo"<a href='index_page_update.php?uid=$id' class='btn btn-md btn-danger'>Hide</a>";
                                            }
                                        ?>
                                    </td>
                                </tr>
