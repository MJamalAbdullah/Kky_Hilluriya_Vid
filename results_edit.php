        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <i class="bi bi-input-cursor-text"></i>
                    <span style="color:Yellow;">Ordinary Results Managed</span>
                </a>
            </li>
...
<?php
    ...
    $sql_se="SELECT * FROM results WHERE index_no=$index;";
    $res=mysqli_query($con,$sql_se);
    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="p-3 py-5">
                ...
                <form method="post" enctype="multipart/form-data" action="">
                    <div class="row mt-2">
                        <div class="col-md-12"><label class="labels">School Index <span class="text-danger">*</span></label><input type="text" name="sclin" class="form-control" value="<?php echo $row['Index_no']; ?>" Disabled placeholder="School Index" value=""  autocomplete="off"></div>
                        <div class="col-md-12"><label class="labels">Examination Index <span class="text-danger">*</span></label><input type="text" name="exin" class="form-control" value="<?php echo $row['Exam_index']; ?>" placeholder="Examination Index" value=""  autocomplete="off"></div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">NIC <span class="text-danger">*</span></label><input type="text" class="form-control" name="nic" minlength="10" value="<?php echo $row['NIC']; ?>" maxlength="12" placeholder="NIC" value=""  autocomplete="off" onkeypress="funNumber()"></div>
                        <div class="col-md-12"><label class="labels">Examination Year & Month<span class="text-danger">*</span></label><input type="month" name="year" class="form-control" placeholder="" value="<?php echo $row['year']; ?>" autocomplete="off" ></div>
                    </div>
                <!-- </form> -->
            </div>
        </div>
        <div class="col-md-9">
            <div class="p-3 py-5">
                <!-- <form method="post"> -->
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="text-right">Ordinary Results Add</h4>
                </div>
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <label class="labels">Tamil <span class="text-danger">*</span></label>
                            <select name="utamil" id="mysel" class="form-control" >
                                <option value="<?php echo $row['Tamil']; ?>"  selected="selected"><?php echo $row['Tamil']; ?></option>
                        ...
                        <div class="col-md-4">
                            <label class="labels">English <span class="text-danger">*</span></label>
                            <select name="uenglish" id="mysel" class="form-control" >
                                <option value="<?php echo $row['English']; ?>"  selected="selected"><?php echo $row['English']; ?></option>
                                    <option value="A">A</option>
                                    <option value="B">B</option>
                                    <option value="C">C</option> 
                                    <option value="S">S</option>
                        ...
                        <div class="col-md-4">
                            <label class="labels">Mathematics <span class="text-danger">*</span></label>
                            <select name="umaths" id="mysel" class="form-control" >
                                <option value="<?php echo $row['Mathematics']; ?>"  selected="selected"><?php echo $row['Mathematics']; ?></option>
                                    <option value="A">A</option>
                                    <option value="B">B</option>
                                    <option value="C">C</option> 
                                    <option value="S">S</option>
                        ...
                        <div class="col-md-4">
                            <label class="labels">Science <span class="text-danger">*</span></label>
                            <select name="uscience" id="mysel" class="form-control" >
                                <option value="<?php echo $row['Science']; ?>"  selected="selected"><?php echo $row['Science']; ?></option>
                                    <option value="A">A</option>
                                    <option value="B">B</option>
                                    <option value="C">C</option> 
                                    <option value="S">S</option>
                        ...
                        <div class="col-md-4">
                            <label class="labels">History <span class="text-danger">*</span></label>
                            <select name="uhistory" id="mysel" class="form-control" >
                                <option value="<?php echo $row['History']; ?>"  selected="selected"><?php echo $row['History']; ?></option>
                                    <option value="A">A</option>
                                    <option value="B">B</option>
                                    <option value="C">C</option> 
                                    <option value="S">S</option>
                        ...
                        <div class="col-md-4">
                            <label class="labels">Islam <span class="text-danger">*</span></label>
                            <select name="uislam" id="mysel" class="form-control" >
                                <option value="<?php echo $row['Islam']; ?>"  selected="selected"><?php echo $row['Islam']; ?></option>
                                    <option value="A">A</option>
                                    <option value="B">B</option>
                                    <option value="C">C</option> 
                                    <option value="S">S</option>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <label class="labels">User Type <span class="text-danger">*</span></label>
                            <select name="ufirst" id="mysel" class="form-control" >
                                <option value="<?php echo $row['first']; ?>"  selected="selected"><?php echo $row['first']; ?></option>
                                    <option value="Information Communication Technologhy">Information Communication Technologhy</option>
                                    <option value="Health Science">Health Science</option>
                                    <option value="Food Technology">Food Technology</option>                                    
                            </select>
                            <br>
                            <select name="ufirst_re" id="mysel" class="form-control" >
                                <option value="<?php echo $row['first_re']; ?>"  selected="selected"><?php echo $row['first_re']; ?></option>
                                    <option value="A">A</option>
                                    <option value="B">B</option>
                                    <option value="C">C</option> 
                                    <option value="S">S</option>
                        ...
                        <div class="col-md-4">
                            <label class="labels">User Type <span class="text-danger">*</span></label>
                            <select name="usec" id="mysel" class="form-control" >
                                <option value="<?php echo $row['second']; ?>"  selected="selected"><?php echo $row['second']; ?></option>
                            ...
                            <br>
                            <select name="usec_re" id="mysel" class="form-control" >
                                <option value="<?php echo $row['sec_re']; ?>"  selected="selected"><?php echo $row['sec_re']; ?></option>
                                    <option value="A">A</option>
                                    <option value="B">B</option>
                                    <option value="C">C</option> 
                                    <option value="S">S</option>
                        ...
                        <div class="col-md-4">
                            <label class="labels">User Type <span class="text-danger">*</span></label>
                            <select name="uthird" id="mysel" class="form-control" >
                                <option value="<?php echo $row['third']; ?>"  selected="selected"><?php echo $row['third']; ?></option>
                                    <option value="Tamil Lit">Tamil Lit</option>
                                    <option value="Art">Art</option>
                                    <option value="Englis Lit">English Lit</option> 
                                    <option value="Arabic Lit">Arabic Lit</option>                                   
                            </select>
                            <br>
                            <select name="uthird_re" id="mysel" class="form-control" >
                                <option value="<?php echo $row['third_re']; ?>"  selected="selected"><?php echo $row['third_re']; ?></option>
                                    <option value="A">A</option>
                                    <option value="B">B</option>
                                    <option value="C">C</option> 
                                    <option value="S">S</option>
                    ...
                    <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="submit" name="update">Save Changes</button> <a href="results.php" class="btn btn-danger profile-button"  name="">Close</a></div>
                </form>
            </div>
        </div>
    </div>
...
<?php
    if (isset($_POST['update']))
    {
        ...
        $history = $_POST['uhistory'];
        $islam = $_POST['uislam'];
        $first_re = $_POST['ufirst_re'];
        $third_re = $_POST['uthird_re'];
        $sec_re = $_POST['usec_re'];

        $first = $_POST['ufirst'];
        $third = $_POST['uthird'];
        $sec = $_POST['usec'];

        $sql="UPDATE results SET Exam_index='$exin',NIC='$nic',year='$year',Tamil='$tamil',English='$english',Mathematics='$maths',Science='$science',History='$history',Islam='$islam',first='$first',first_re='$first_re',second='$sec',sec_re='$sec_re',third='$third',third_re='$third_re' WHERE  index_no=$index;";
        $exe=mysqli_query($con,$sql);

        if($exe)
        {
            echo"<script> alert('Results Changed'); location.replace('results.php');</script>";
        }
        else
        {
    ...
    if(isset($_POST['savepw']))
    {
        ...
        if ($decryption_pass == $cpw)
        {
            if($npw == $rnpw)
            {
                ...
                if($respw)
                {
                    echo "<script> alert('Password Successfuly Changed.'); location.replace('./user_reg.php') </script>"; 
                }
            ...
            {
                echo "<script> alert('Please Verify The Both Passwords are Same.'); location.replace('./user_reg.php') </script>";
            }
        }
        else
        {
            echo "<script> alert('Please Verify The Current Password is Correct.'); location.replace('./user_reg.php') </script>";
        }       
    }
