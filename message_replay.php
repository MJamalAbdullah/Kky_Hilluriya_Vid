        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <i class="bi bi-envelope-open-fill"></i>
                    <span style="color:Yellow;">Feedbacks</span>
                </a>
            </li>
        ...
        <div class="col-md-6 border-right">
            <div class="p-3 py-5">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="row mt-2">
                        <div class="col-md-6"><label class="labels">Name <span class="text-danger">*</span></label><input type="text" name="firstnm" class="form-control" disabled value="<?php echo $name; ?>" required="require" autocomplete="off"></div>
                        <div class="col-md-6"><label class="labels">Contact Number <span class="text-danger">*</span></label><input type="tel" name="phone" class="form-control" disabled value="<?php echo $phone; ?>" required="require" autocomplete="off"></div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Message <span class="text-danger">*</span></label><textarea name="" id="" class="form-control" cols="30" rows="10" disabled><?php echo $msg; ?></textarea></div>
                    </div>
                </form>
            </div>
        </div>
        <div class="col-md-6">
            <div class="p-3 py-5">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">E-mail <span class="text-danger">*</span></label><input type="email" name="mail" class="form-control"  value="<?php echo $email; ?>" required="require" autocomplete="off"></div>
                    ...
                    <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="submit" name="replay">Reply</button> <a href="message.php" class="btn btn-danger profile-button">Close</a></div>
                </form>
            </div>
        </div>
    </div>
