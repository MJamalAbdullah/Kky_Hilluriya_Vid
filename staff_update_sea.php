...
<!-- ----------------------------------------------------------------------------------------------------------------------------  -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Staff Details Change</h1>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="" method="post">
            <div>
                <label> <b> Search By Satff Number Here : </b> </label>
                <input type="text" class="form-control" name="staffn" placeholder="XXXXXX" required="require" autocomplete="off" onkeypress="funNumber()" ><br>
                ...
                <thead>
                    <?php
                        ...
                        if(isset($_POST['search']))
                        {
                            ...
                            $staffnum=$_POST['staffn'];

                            $sql="SELECT * FROM staff WHERE staff_no='$staffnum'";
                            $exe=mysqli_query($con,$sql);
                                ...
                                if($exe)
                                {
                                    ...
                                    {  
                                        ...
                                        print("<tr>");
                                            ...
                                            print ("<td align='center'>");
                                                // print("<a href='#' class='btn btn-danger btn-md' data-bs-toggle='modal' data-bs-target='#condlt'>Delete</a>");
                                                print("   ");
    ...
    if(isset($_POST['savepw']))
    {
        ...
        if ($decryption_pass == $cpw)
        {
            if($npw == $rnpw)
            {
                ...
                if($respw)
                {
                    echo "<script> alert('Password Successfuly Changed.'); location.replace('./staff_update_sea.php') </script>"; 
                }
            ...
            {
                echo "<script> alert('Please Verify The Both Passwords are Same.'); location.replace('./staff_update_sea.php') </script>";
            }
        }
        else
        {
            echo "<script> alert('Please Verify The Current Password is Correct.'); location.replace('./staff_update_sea.php') </script>";
        }       
    }
