    ...
    if(isset($_POST['save']))
    {
        ...
        if(isset($_FILES['dp']))
        {
            ...
            if(!$_FILES['dp']['size'] <= 3072)
            {
                ...
                if($exeup)
                {
                    echo "<script> alert('Your Profile Updated .'); location.replace('./profile_student.php'); </script>";
                }
                else
                {
            ...
            {
                echo "<script> alert('The File Size Is to Large...! Please Upload Lessthen 3MB.'); location.replace('./profile_student.php') </script>";
            }
        }
