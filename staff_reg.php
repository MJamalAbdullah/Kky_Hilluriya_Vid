            ...
            <li class="nav-item">
                ...
                <div id="staff" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="staff_reg.php"><i class="bi bi-person-add"></i> <span style="color:Red;">Staff Registeration</span></a>
                ...
                <div class="col-sm-12" align="center">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h4 class="m-0 font-weight-bold text-primary" align="left"><span>Staff  Registration</span></h4>
                        </div>
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="table-responsive">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" class="form-control" name="staffnu" placeholder="XXXXXX" required="require" autocomplete="off" onkeypress="funNumber()">
                                            </td>
                                            <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                                <input type="text" class="form-control" name="fname" placeholder="Jhon" required="require" autocomplete="off">
                                            </td>
                                            <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                                <input type="text" class="form-control" name="lname" placeholder="Smith" required="require" autocomplete="off">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>                                        
                                            <td>
                                                <input type="text" class="form-control" name="address" placeholder="No 09,APC Road,Vantharmoolai,Batticaloa" required="require" autocomplete="off">
                                            </td>
                                            <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                                <input type="text" class="form-control" name="nic" placeholder="NIC Number" required="require" autocomplete="off">
                                            </td>
                                            <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                                <input type="email" class="form-control" name="email" placeholder="VTA@GMAIL.COM" required="require" autocomplete="off">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="tel" class="form-control" name="contact" placeholder="07XXXXXXXX" required="require" autocomplete="off" onkeypress="funNumber()" >
                                            </td>
                                            <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                                <input type="date" class="form-control" name="apdate" placeholder="First Appoinment Date" required="require" autocomplete="off">
                                            </td>
                                            <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                                <select name="staffcat" id="" required="require" class="form-control">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="date" class="form-control" name="doj" placeholder="Mother Name" required="require" autocomplete="off">
                                            </td>
                                            <!-- <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td align="right" colspan="2">
                                                <button type="submit" class="btn btn-primary btn-lg" name="submit"><i class="bi bi-person-add"></i>  Register</button>
                                            </td>
    ...
    if(isset($_POST['savepw']))
    {
        ...
        if ($decryption_pass == $cpw)
        {
            if($npw == $rnpw)
            {
                ...
                if($respw)
                {
                    echo "<script> alert('Password Successfuly Changed.'); location.replace('./staff_reg.php') </script>"; 
                }
            ...
            {
                echo "<script> alert('Please Verify The Both Passwords are Same.'); location.replace('./staff_reg.php') </script>";
            }
        }
        else
        {
            echo "<script> alert('Please Verify The Current Password is Correct.'); location.replace('./staff_reg.php') </script>";
        }       
    }
...
<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        $sql="INSERT INTO staff(staff_no,first_nm,last_nm,address,nic,mail,contact_no,appoinment_date,staff_cate,date_of_join)
             VALUES ('$stid','$fname','$lname','$address','$nic','$email','$contact','$apdate','$staffcate','$doj')";
        $exe=mysqli_query($con,$sql);

        if($exe)
        {
            //Header('Location:staff_reg.php');
            echo "<script> alert('Record Insert Successfully.'); location.replace('./staff_reg.php') </script>";
        }
        else
        {
