<?php
    ...
    // ----------------APPLICATION---------------
    $sqlapp ="select * from applicationsecon";
    $exeapp=mysqli_query($con,$sqlapp);
    $app=mysqli_num_rows($exeapp);
    // ------------------------------------------

    // ----------------Students---------------
    $sqlstud ="select * from students";
    $exestud=mysqli_query($con,$sqlstud);
    $stud=mysqli_num_rows($exestud);
    // ------------------------------------------

    // ----------------staffs---------------
    $sqlstaff="Select * from staff";
    $exestaff=mysqli_query($con,$sqlstaff);
    $staff=mysqli_num_rows($exestaff);
    // ------------------------------------------

    // ----------------pending Request---------------
    $sqlrequest="Select * from request";
    $exerequest=mysqli_query($con,$sqlrequest);
    $request=mysqli_num_rows($exerequest);
    // ------------------------------------------
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="ma-do.php">
            ...
            <li class="nav-item">
                ...
                <div id="students" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="student_data_view.php" style="pointer-events: none;"><i class="bi bi-people"></i> <span>Student Record View</span></a>
                        <a class="collapse-item" href="student_update_sea.php" style="pointer-events: none;"><i class="bi bi-pencil-square"></i> <span>Students Edit</span>  </a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="guardians" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="guardians_view.php" style="pointer-events: none;"><i class="bi bi-people"></i> <span>Guardians Record View</span></a>
                        <a class="collapse-item" href="guardians_update_sear.php" style="pointer-events: none;"><i class="bi bi-pencil-square"></i> <span>Guardians Edit</span>  </a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="staff" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="staff_view.php"><i class="bi bi-people" style="pointer-events: none;" ></i> <span>Staff Record View</span></a>
                        <a class="collapse-item" href="staff_update_sea.php"><i class="bi bi-pencil-square" style="pointer-events: none;" ></i> <sapn>Staff Edit</sapn></a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="user" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="user_reg.php"><i class="bi bi-person-vcard-fill" style="pointer-events: none;"></i> <span>Account Create</span></a>
                        <a class="collapse-item" href="user_view.php"><i class="bi bi-binoculars-fill" style="pointer-events: none;"></i> <span>Staff Record View</span></a>
...
<?php
        ...
        $sql="SELECT * FROM messages WHERE read_status=0 LIMIT 3;";
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="bi bi-input-cursor-text fa-3x"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $stud?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="bi bi-people-fill fa-3x"></i></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $request?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="bi bi-person-fill-add fa-3x"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <iframe width="100%" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3954.024525329612!2d81.72007841477746!3d7.680511794463057!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae532e8f6a608f3%3A0x804d9c04545086ce!2sHiluriya%20Vidyalaya%2C%20B337%2C%20Kattankudy!5e0!3m2!1sen!2slk!4v1669704085740!5m2!1sen!2slk" width="1500" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    if(isset($_POST['savepw']))
    {
        ...
        if ($decryption_pass == $cpw)
        {
            if($npw == $rnpw)
            {
                ...
                if($respw)
                {
                    echo "<script> alert('Password Successfuly Changed.'); location.replace('./indexma.php') </script>"; 
                }
            ...
            {
                echo "<script> alert('Please Verify The Both Passwords are Same.'); location.replace('./indexma.php') </script>";
            }
        }
        else
        {
            echo "<script> alert('Please Verify The Current Password is Correct.'); location.replace('./indexma.php') </script>";
        }       
    }
