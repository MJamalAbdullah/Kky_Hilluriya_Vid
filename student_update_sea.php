                ...
                <thead>
                    <?php
                        ...
                        if(isset($_POST['search']))
                        {
                            ...
                            $sql="SELECT * FROM students WHERE index_no='$indexnum'";
                            $exe=mysqli_query($con,$sql);
    ...
    if(isset($_POST['savepw']))
    {
        ...
        if ($decryption_pass == $cpw)
        {
            if($npw == $rnpw)
            {
                ...
                if($respw)
                {
                    echo "<script> alert('Password Successfuly Changed.'); location.replace('./student_update_sea.php') </script>"; 
                }
            ...
            {
                echo "<script> alert('Please Verify The Both Passwords are Same.'); location.replace('./student_update_sea.php') </script>";
            }
        }
        else
        {
            echo "<script> alert('Please Verify The Current Password is Correct.'); location.replace('./student-update_sea.php') </script>";
        }       
    }
