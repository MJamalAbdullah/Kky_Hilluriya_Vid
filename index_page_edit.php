        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index_page.php">
                    ...
                    <span style="color:Yellow;">Index Page Settings</span></a>
            </li>
        ...
        <div class="card-body">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label >Title :</label>
                        <select name="name" id="mysel" class="form-control" required="require">
                            <option value="<?php echo $row['title'];?>" selected="selected"><?php echo $row['title'];?></option>
                            <option value="Image Slider (Crosel)">Image Slider (Crosel)</option>
                            <option value="The School Profile">The School Profile</option>
                            <option value="About Our School">About Our School</option> 
                            <option value="About Our Principal">About Our Principal</option>
                            <option value="How to Works It">How to Works It</option>
                        </select>
                </div>

                <div class="form-group">
                    <label >Description :</label>
                    <!-- <input class="form-control" type="text" paceholder="Description" autocomplete="off" value="<?php echo $row['description'];?>" name="desc" required> -->
                    <textarea name="desc" id="" class="form-control" cols="30" rows="10" maxlength="" ><?php echo $row['description'];?></textarea>
                </div>

                <div class="form-group">
                    <label >Image :</label>
                    <input class="form-control" type="File" paceholder="Image" id="img" accept="image/*" name="img" ><br>
                    <center><a href="index_page_img/<?php echo $row['image']; ?>"><img class="img-profile "  alt="Image" src="index_page_img/<?php echo $row['image']; ?>" width="200px" height="200px"></a><br></center>
                </div>
                    
                <div class="form-group" align="center">
                    <a class="btn btn-secondary" href="index_page.php">Cancel</a>
    ...
    if(isset($_POST['save']))
    {
        ...
        if(isset($_FILES["img"]))
        {
            ...
            if(!$file_size < 3072)
            {
                ...
                {
                    if($img_path ="index_page_img/".$row['image'])
                    {
                        unlink($img_path);
                        $img_data=$img;
                    }
                ...
                move_uploaded_file($_FILES["img"]["tmp_name"], "index_page_img/".$_FILES["img"]["name"]);

                $sql="UPDATE index_page SET title='$name',description='$desc',image='$img_data' WHERE id='$id';";
                $res=mysqli_query($con,$sql);

                if($res)
                {
                    echo "<script> alert('File Updated Successfully.'); location.replace('./index_page.php') </script>";
                }
                else
                {
            ...
            {
                echo "<script> alert('The File Size Is to Large...! Please Upload Lessthen 3MB.'); location.replace('./index_page.php') </script>";
            }
        }
    }
?>
