    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="p-3 py-5">
                ...
                <form method="post" enctype="multipart/form-data" action="results_upload.php">
                    <div class="row mt-2">
        ...
        <div class="col-md-9">
            <div class="p-3 py-5">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="submit" name="save">SAVE</button></div>
                </form>
            </div>
        </div>
    </div>
