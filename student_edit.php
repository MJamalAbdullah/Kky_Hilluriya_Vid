            ...
            <li class="nav-item">
                ...
                <div id="students" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="student_update_sea.php"><i class="bi bi-pencil-square"></i> <span style="color:Red;">Students Edit</span>  </a>
                    </div>
                </div>
            </li>
    ...
    <div class="row">
        ...
        <div class="col-md-10 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                        <div class="col-md-12"><label class="labels">Index <span class="text-danger">*</span></label><input type="text" disabled value=<?php echo $index;?> onkeypress="funNumber()" name="aindexnu" class="form-control" placeholder="Index" value="" required="require" autocomplete="off"></div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-6"><label class="labels">Firs Name <span class="text-danger">*</span></label><input type="text" name="tfname" value=<?php echo $finame;?> class="form-control" placeholder="First Name" value="" required="require" autocomplete="off"></div>
                        <div class="col-md-6"><label class="labels">Last Name <span class="text-danger">*</span></label><input type="text" name="tlname" value=<?php echo $laname;?> class="form-control" value="" placeholder="Last Name" required="require" autocomplete="off"></div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-6"><label class="labels">Date Of Birth <span class="text-danger">*</span></label><input type="Date" name="tdob" value=<?php echo $dob;?> class="form-control"  required="require" value="" autocomplete="off" onkeypress="funNumber()"></div>
                        <div class="col-md-6"><label class="labels">Birth Certificate No <span class="text-danger">*</span></label><input type="text" name="tbcn" value=<?php echo $bcn;?> class="form-control" placeholder="Birth Certificate No" required="require" value="" autocomplete="off"></div>
                        <div class="col-md-12"><label class="labels">Address <span class="text-danger">*</span></label><input type="text" class="form-control" name="taddress" value=<?php echo $address;?> placeholder="Address" value="" required="require" autocomplete="off"></div>
                        <div class="col-md-12"><label class="labels">Gender <span class="text-danger">*</span></label> <br>
                            ...
                            <input type="radio" checked="" name="gender"  required="require" value="Male" checked=<?php if($row['gender'] = "Male") { echo "true"; }?> autocomplete="off" required="require"> <label class="labels">Male</label></input>
                            <input type="radio" name="gender" required="require" value="Female" checked=<?php if($row['gender'] = "Female") { echo "true"; }?> autocomplete="off" required="require"> <label class="labels">Female</label></input>
                        </div>
                        <div class="col-md-6"><label class="labels">Emergency Contact Number <span class="text-danger">*</span></label><input type="tell" name="temgcon" value=<?php echo $emg;?> onkeypress="funNumber()" class="form-control" placeholder="Emergency Contact Number" minlength="10" maxlength="10" value="" autocomplete="off" required="require"></div>
                        <div class="col-md-6"><label class="labels">Date Of Join <span class="text-danger">*</span></label><input type="Date" disabled name="tdoj" class="form-control" placeholder="" value=<?php echo $doj;?> autocomplete="off" required="require"></div>                    
                    </div>
                    <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="submit" name="update">Save Changes</button> <a class="btn btn-danger profile-button" href="student_data_view.php" name="">Back</a></div>
                </form>
            </div>
        </div>
        <div class="col-md-1">
    ...
    if(isset($_POST['savepw']))
    {
        ...
        if ($decryption_pass == $cpw)
        {
            if($npw == $rnpw)
            {
                ...
                if($respw)
                {
                    echo "<script> alert('Password Successfuly Changed.'); location.replace('./student_edit.php') </script>"; 
                }
            ...
            {
                echo "<script> alert('Please Verify The Both Passwords are Same.'); location.replace('./student_edit.php') </script>";
            }
        }
        else
        {
            echo "<script> alert('Please Verify The Current Password is Correct.'); location.replace('./student_edit.php') </script>";
        }       
    }
...
<?php
    if(isset($_POST['update']))
    {
        ...
        $bcn=$_POST['tbcn'];
        $emgcon=$_POST['temgcon'];
        $gender=$_POST['gender'];
        // $doj=$_POST['tdoj'];  ,doj='$doj'    index_no='$indexnu',
        
        $sql="UPDATE students set  first_nm='$fname', last_nm='$lname', dob='$dob',address='$address',birtherificate_no='$bcn',emrg_con_no='$emgcon',gender='$gender' where id=$id";
        $res = mysqli_query($con,$sql);

        if($res)
        {
            echo "<script> alert('Record Successfully Updated.'); location.replace('./student_data_view.php') </script>";
        }
        else
        {
