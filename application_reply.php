    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <i class="bi bi-input-cursor-text"></i>
                    <span style="color:Yellow;">Application</span>
                </a>
            </li>
...
<?php
    ...
    $sql="SELECT * FROM applicationsecon WHERE id='$id';";
    $exe=mysqli_query($con,$sql);
...
<div class="container rounded bg-white mt-5 mb-5 shadow">
    <div class="row">
        <div class="col-md-6 border-right">
            <div class="p-3 py-5">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="row mt-2">
                        <div class="col-md-6"><label class="labels">Applicant Name <span class="text-danger">*</span></label><input type="text" name="apname" class="form-control" disabled value="<?php echo $name; ?>" required="require" autocomplete="off"></div>
                        <div class="col-md-6"><label class="labels">Applied For Grade <span class="text-danger">*</span></label><input type="text" name="garde" class="form-control" disabled value="<?php echo $grade; ?>" required="require" autocomplete="off"></div>
                        <div class="col-md-6"><label class="labels">Parent Name <span class="text-danger">*</span></label><input type="text" name="prnm" class="form-control" disabled value="<?php echo $prnm; ?>" required="require" autocomplete="off"></div>
                        <div class="col-md-6"><label class="labels">Parent NIC <span class="text-danger">*</span></label><input type="text" name="pnic" class="form-control" disabled value="<?php echo $pnic; ?>" required="require" autocomplete="off"></div>
                        <div class="col-md-6"><label class="labels">Parent Name <span class="text-danger">*</span></label><input type="text" name="prnm" class="form-control" disabled value="<?php echo $prnm; ?>" required="require" autocomplete="off"></div>
                        <div class="col-md-6"><label class="labels">Parent Name <span class="text-danger">*</span></label><input type="text" name="prnm" class="form-control" disabled value="<?php echo $poccu; ?>" required="require" autocomplete="off"></div>
                        <div class="col-md-12"><label class="labels">Contact Number <span class="text-danger">*</span></label><input type="tel" name="phone" class="form-control" disabled value="<?php echo $phone; ?>" required="require" autocomplete="off"></div>
                        <div class="col-md-12"><label class="labels">E-mail <span class="text-danger">*</span></label><input type="email" name="email" class="form-control" disabled value="<?php echo $email; ?>" required="require" autocomplete="off"></div>
                    </div>
                </form>
            </div>
        </div>
        <div class="col-md-6">
            <div class="p-3 py-5">
                <form method="post" action="application_mail.php">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="text-right">Reply</h4>
                </div>
                    <div class="row mt-3">
                        <div class="col-md-6"><label class="labels">E-mail <span class="text-danger">*</span></label><input type="email" name="mail" class="form-control"  value="<?php echo $email; ?>" required="require" autocomplete="off"></div>
                        <div class="col-md-6"><label class="labels">Refference Number <span class="text-danger">*</span></label><input type="text" name="refno" class="form-control" value="<?php echo "Hiluriya-".$grade."-".$id; ?>" required="require" autocomplete="off"></div>
                        <div class="col-md-6"><label class="labels">Interview Date <span class="text-danger">*</span></label><input type="date" name="date" class="form-control"  required="require" autocomplete="off"></div>
                        <div class="col-md-6"><label class="labels">Venue <span class="text-danger">*</span></label><input type="text" name="venue" class="form-control"   required="require" autocomplete="off"></div>
                        <div class="col-md-12"><label class="labels">Message <span class="text-danger">*</span></label><textarea name="msg" id="" class="form-control" cols="30" rows="10" ><?php ?></textarea></div>
                    </div>                     
                    <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="submit" name="reply">Reply</button> <a href="application.php" class="btn btn-danger profile-button">Close</a></div>
                </form>
            </div>
        </div>
    </div>
...
<?php
    if(isset($_POST['save']))
    {
        ...
        move_uploaded_file($_FILES["img"]["tmp_name"], "register/img/".$_FILES["img"]["name"]);
        //encrypt data
        ...
        $encryptpw = openssl_encrypt($pass, $ciphering,
                $encryption_key, $options, $encryption_iv);

        $sql1="INSERT INTO user (First_Name,Last_Name,DOB,Gender,email,phone,username,password,usertype,index_or_staff,NIC,image,u_status) VALUES ('$firstnm','$lastnm','$dobd','$gender','$emailadd','$mobile','$uname','$encryptpw','$st_type','$staffid','$nic','$img','1')";
        $res=mysqli_query($con,$sql1);

        if($res)
        {
            echo "<script> alert('User Profile Created.'); location.replace('./user_reg.php') </script>";
        }
    }
?>
<!-- ------------------------------------------------------------------------------------------------------------------------------------------------ -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1>Delete</h1>
                    <div class="button btn-close" data-bs-dismiss="modal"></div>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#condlt">Delete</button>
                </div>
            </div>
        </div>
    </div> -->
    ...
    if(isset($_POST['savepw']))
    {
        ...
        if ($decryption_pass == $cpw)
        {
            if($npw == $rnpw)
            {
                ...
                if($respw)
                {
                    echo "<script> alert('Password Successfuly Changed.'); location.replace('./application_reply.php') </script>"; 
                }
            ...
            {
                echo "<script> alert('Please Verify The Both Passwords are Same.'); location.replace('./application_reply.php') </script>";
            }
        }
        else
        {
            echo "<script> alert('Please Verify The Current Password is Correct.'); location.replace('./application_reply.php') </script>";
        }       
    }
