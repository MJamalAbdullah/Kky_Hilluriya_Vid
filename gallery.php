                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td> <img class="img-profile " alt="Image" src="gallery_img/<?php echo $row['image'];?>" width="100px" height="100px"> </td>
                                    ...
                                    <td>
                                        <?php
                                            if ($status=='1')
                                            {
                                                echo"<a href='gallery_status_update.php?uid=$id' class='btn btn-md btn-success'>Show</a>";
                                            }
                                            else
                                            {
                                                echo"<a href='gallery_status_update.php?uid=$id' class='btn btn-md btn-danger'>Hide</a>";
                                            }
                                        ?>
                                    </td>
                                </tr>
