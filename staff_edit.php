<?php
    ...
    $row=mysqli_fetch_assoc($resa);
        ...
        $apndate=$row['appoinment_date'];
        $staffcat=$row['staff_cate'];
        $daoj=$row['date_of_join'];
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <li class="nav-item">
                ...
                <div id="staff" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="staff_update_sea.php"><i class="bi bi-pencil-square"></i> <sapn style="color:Red;">Staff Edit</sapn></a>
                    </div>
                </div>
            </li>
                ...
                <div class="col-sm-12" align="center">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h4 class="m-0 font-weight-bold text-primary" align="left"><span>Staff  Update</span></h4>
                        </div>
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="table-responsive">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" class="form-control" name="staffnu" placeholder="XXXXXX" required="require" autocomplete="off" disabled onkeypress="funNumber()" value="<?php echo $staffnum;?>">
                                            </td>
                                            <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                                <input type="text" class="form-control" name="fname" placeholder="Jhon" required="require" autocomplete="off" value="<?php echo $fname;?>" >
                                            </td>
                                            <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                                <input type="text" class="form-control" name="lname" placeholder="Smith" required="require" autocomplete="off" value="<?php echo $lname;?>" >
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>                                        
                                            <td>
                                                <input type="text" class="form-control" name="address" placeholder="No 09,APC Road,Vantharmoolai,Batticaloa" required="require" autocomplete="off" value="<?php echo $address;?>" >
                                            </td>
                                            <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                                <input type="text" class="form-control" name="nic" placeholder="NIC Number" required="require" autocomplete="off" value="<?php echo $nic;?>" >
                                            </td>
                                            <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                                <input type="email" class="form-control" name="email" placeholder="VTA@GMAIL.COM" required="require" autocomplete="off" value="<?php echo $mail;?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="tel" class="form-control" name="contact" placeholder="07XXXXXXXX" required="require" autocomplete="off" onkeypress="funNumber()" value="<?php echo $contact;?>" >
                                            </td>
                                            <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                                <input type="date" class="form-control" name="apdate" placeholder="First Appoinment Date" required="require" autocomplete="off" value="<?php echo $apndate;?>" >
                                            </td>
                                            <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                                <select name="staffcat" id="" required="require" class="form-control" value="">
                                                    <option value="<?php echo $staffcat;?>"><?php echo $staffcat;?></option>
                                                    <option value="Accadamic Staff">Accadamic Staff</option>
                                                    <option value="Non Accadamic Staff">Non Accadamic Staff</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="date" class="form-control" name="doj" placeholder="Mother Name" required="require" autocomplete="off" value="<?php echo $daoj;?>">
                                            </td>
                                            <!-- <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                                <input type="text" class="form-control" name="mnic" placeholder="Mother NIC" required="require" autocomplete="off">
                                            </td>
                                            <td>&nbsp; &nbsp; &nbsp;</td>
                                            <td>
                                                <input type="text" class="form-control" name="moccu" placeholder="Occupution" required="require" autocomplete="off">
                                            </td> -->
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td align="right" colspan="2">
                                                <button type="submit" class="btn btn-primary btn-lg" name="submit"><i class="fa fa-save"></i>  Update</button>
                                            </td>
    ...
    if(isset($_POST['savepw']))
    {
        ...
        if ($decryption_pass == $cpw)
        {
            if($npw == $rnpw)
            {
                ...
                if($respw)
                {
                    echo "<script> alert('Password Successfuly Changed.'); location.replace('./staff_edit.php') </script>"; 
                }
            ...
            {
                echo "<script> alert('Please Verify The Both Passwords are Same.'); location.replace('./staff_edit.php') </script>";
            }
        }
        else
        {
            echo "<script> alert('Please Verify The Current Password is Correct.'); location.replace('./staff_edit.php') </script>";
        }       
    }
...
<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        $apdate=$_POST['apdate'];
        $staffcate=$_POST['staffcat'];
        $doj=$_POST['doj'];

        //print(" $stid  $fname  $lname  $address  $nic  $email $contact $apdate $staffcate $doj");

        
        $sql="UPDATE staff SET first_nm='$fname', last_nm='$lname',address='$address',nic='$nic',mail='$email',contact_no='$contact',appoinment_date='$apdate',staff_cate='$staffcate',date_of_join='$doj'";
        $exe=mysqli_query($con,$sql);

        if($exe)
        {
            //Header('Location:staff_reg.php');
            echo "<script> alert('Record Successfully Updated.'); location.replace('./staff_view.php') </script>";
        }
        else
        {
