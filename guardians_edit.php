<?php
    ...
    $sql1="select * from guardians where id='$id'";
    $resa= mysqli_query($con,$sql1);

    $row=mysqli_fetch_assoc($resa);
        $index=$row['index_no'];
        $faname=$row['father_name'];
        $laname=$row['father_nic'];
        $dob=$row['father_occu'];
        $address=$row['mother_name'];
        $bcn=$row['mother_nic'];
        $emg=$row['mother_occu'];
        $doj=$row['parents_con_no'];
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <li class="nav-item">
                ...
                <div id="guardians" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="guardians_update_sear.php"><i class="bi bi-pencil-square"></i> <span style="color:red;">Guardians Edit</span>  </a>
                    </div>
                </div>
            </li>
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                    ...
                                    <?php
                                        ...
                                        $row=mysqli_fetch_array($exe);
                                            ...
                                            $lname=$row['Last_Name'];
                                        echo "Wel Come Back!  ".$fname." ".$lname;
                                    ?>
                                    </b>
                                </span>
        ...
        <div class="col-md-10 border-right">
            <div class="p-3 py-5">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Index <span class="text-danger">*</span></label><input type="text" name="index" disabled value=<?php echo $index;?> class="form-control" placeholder="Mother Name"  value="" autocomplete="off" required="require"></div>                    
                    </div> 
                    <div class="row mt-3">
                        <div class="col-md-6"><label class="labels">Father Name <span class="text-danger">*</span></label><input type="text" name="fname" value=<?php echo $faname;?> class="form-control" placeholder="Father Name" value="" autocomplete="off" required="require"></div>
                        <div class="col-md-6"><label class="labels">Mother Name <span class="text-danger">*</span></label><input type="text" name="mname" value=<?php echo $address;?> class="form-control" placeholder="Mother Name"  value="" autocomplete="off" required="require"></div>                    
                    </div>  
                    <div class="row mt-3">
                        <div class="col-md-6"><label class="labels">Father NIC <span class="text-danger">*</span></label><input type="text" name="fnic" value=<?php echo $laname;?> class="form-control" placeholder="Father NIC" value="" minlength="10" maxlength="12" autocomplete="off" required="require"></div>
                        <div class="col-md-6"><label class="labels">Mother NIC <span class="text-danger">*</span></label><input type="text" name="mnic" value=<?php echo $bcn;?> class="form-control" placeholder="Mother NIC" minlength="10" maxlength="12" value="" autocomplete="off" required="require"></div>                    
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-6"><label class="labels">Father Occupution <span class="text-danger">*</span></label><input type="text" name="foccu" value=<?php echo $dob;?> class="form-control" placeholder="Father Occupution" value="" autocomplete="off" required="require"></div>
                        <div class="col-md-6"><label class="labels">Mother Occupution <span class="text-danger">*</span></label><input type="text" name="moccu" value=<?php echo $emg;?> class="form-control" placeholder="Mother Occupution"  value="" autocomplete="off" required="require"></div>                    
                    </div> 
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Parents Contact Number <span class="text-danger">*</span></label><input type="tel" name="pcn" value=<?php echo $doj;?> onkeypress="funNumber()" class="form-control" minlength="10" maxlength="10" placeholder="Parents Contact Number" value="" autocomplete="off" required="require"></div>
                    </div>                  
                    <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="submit" name="update">Register</button> <a class="btn btn-danger profile-button" href="guardians_view.php" name="">Back</a></div>
                </form>
            </div>
        </div>
        <div class="col-md-1">
    ...
    if(isset($_POST['savepw']))
    {
        ...
        if ($decryption_pass == $cpw)
        {
            if($npw == $rnpw)
            {
                ...
                if($respw)
                {
                    echo "<script> alert('Password Successfuly Changed.'); location.replace('./guardians_view.php') </script>"; 
                }
            ...
            {
                echo "<script> alert('Please Verify The Both Passwords are Same.'); location.replace('./guardians_view.php') </script>";
            }
        }
        else
        {
            echo "<script> alert('Please Verify The Current Password is Correct.'); location.replace('./guardians_view.php') </script>";
        }       
    }
...
<?php
    if(isset($_POST['update']))
    {
        ...
        $sql="update guardians set  father_name='$fname', father_nic='$fnic', father_occu='$foccu',mother_name='$mname',mother_nic='$mnic',mother_occu='$moccu',parents_con_no='$pcn'  where id=$id";
        $res = mysqli_query($con,$sql);

        if($res)
        {
            echo "<script> alert('Record Successfully Updated.'); location.replace('./guardians_view.php') </script>";
        }
        else
        {
