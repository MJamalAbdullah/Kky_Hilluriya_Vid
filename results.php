...
<!-- ------------------------------------------------------------------------------------------------------------------------------------------------ -->
<!-- Modal -->
    <div class="modal fade" id="results" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <!-- <div class="col-md-3 border-right"> -->
                        <div class="p-3 py-5">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12"><label class="labels">School Index <span class="text-danger">*</span></label><input type="text" name="sclin" class="form-control" placeholder="School Index" value="" required="require" autocomplete="off"></div>
                                <div class="col-md-12"><label class="labels">Examination Index <span class="text-danger">*</span></label><input type="text" name="exin" class="form-control" placeholder="Examination Index" value="" required="require" autocomplete="off"></div>
                            </div>
                            <div class="row mt-3">
                                ...
                                <div class="col-md-12"><label class="labels">Examination Year & Month<span class="text-danger">*</span></label><input type="month" name="year" class="form-control" placeholder="" value="" autocomplete="off" required="require"></div>
                            </div>
                        </div>
                    <!-- </div> -->
                    <!-- <div class="col-md-9"> -->
                        <div class="p-3 py-5">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                             ...
                             <div class="row mt-3">
                                <div class="col-md-4">
                                    ...
                                    <select name="tamil" id="mysel" class="form-control" required="require">
                                        <option value="" disabled="disabled" selected="selected">Choose Results</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="english" id="mysel" class="form-control" required="require">
                                        <option value="" disabled="disabled" selected="selected">Choose Results</option>
                                            <option value="A">A</option>
                                            <option value="B">B</option>
                                            <option value="C">C</option> 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="maths" id="mysel" class="form-control" required="require">
                                        <option value="" disabled="disabled" selected="selected">Choose Results</option>
                                            <option value="A">A</option>
                                            <option value="B">B</option>
                                            <option value="C">C</option> 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="science" id="mysel" class="form-control" required="require">
                                        <option value="" disabled="disabled" selected="selected">Choose Results</option>
                                            <option value="A">A</option>
                                            <option value="B">B</option>
                                            <option value="C">C</option> 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="history" id="mysel" class="form-control" required="require">
                                        <option value="" disabled="disabled" selected="selected">Choose Results</option>
                                            <option value="A">A</option>
                                            <option value="B">B</option>
                                            <option value="C">C</option> 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="islam" id="mysel" class="form-control" required="require">
                                        <option value="" disabled="disabled" selected="selected">Choose Results</option>
                                            <option value="A">A</option>
                                            <option value="B">B</option>
                                            <option value="C">C</option> 
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4">
                                    <label class="labels">1st Choice Subjects <span class="text-danger">*</span></label>
                                    <select name="first" id="mysel" class="form-control" required="require">
                                    ...
                                    <br>
                                    <select name="first_re" id="mysel" class="form-control" required="require">
                                        <option value="" disabled="disabled" selected="selected">Choose Results</option>
                                            <option value="A">A</option>
                                            <option value="B">B</option>
                                            <option value="C">C</option> 
                                ...
                                <div class="col-md-4">
                                    <label class="labels">2nd Choice Subjects <span class="text-danger">*</span></label>
                                    <select name="sec" id="mysel" class="form-control" required="require">
                                        <option value="" disabled="disabled" selected="selected">Choose Option</option>
                                    ...
                                    <br>
                                    <select name="sec_re" id="mysel" class="form-control" required="require">
                                        <option value="" disabled="disabled" selected="selected">Choose Results</option>
                                            <option value="A">A</option>
                                            <option value="B">B</option>
                                            <option value="C">C</option> 
                                ...
                                <div class="col-md-4">
                                    <label class="labels">3rd Choice Subjects <span class="text-danger">*</span></label>
                                    <select name="third" id="mysel" class="form-control" required="require">
                                        <option value="" disabled="disabled" selected="selected">Choose Option</option>
                                    ...
                                    <br>
                                    <select name="third_re" id="mysel" class="form-control" required="require">
                                        <option value="" disabled="disabled" selected="selected">Choose Results</option>
                                            <option value="A">A</option>
                                            <option value="B">B</option>
                                            <option value="C">C</option> 
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Results Upload Form
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#results">
                    ADD 
                </button>
            </h6>
        </div>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>School Index</th>
                            <th>Examination Index</th>
                            <th>NIC Of The Examiner</th>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td> <?php echo $row['Exam_index']; ?> </td>
                                    <td> <?php echo $row['NIC']; ?> </td>
                                    <td> <?php echo $row['year']; ?> </td>
                                    <td> <?php echo"<a href='results_edit.php?uindex=$id' class='btn btn-primary'>View</a>"?></td>
                                    <td> <?php echo "<a href='results_dlt.php?did=$id' class='btn btn-danger btn-md'>Delete</a>"?></td>
                                </tr>
                        <?php
                            }
                        ?>
    ...
    if(isset($_POST['savepw']))
    {
        ...
        if ($decryption_pass == $cpw)
        {
            if($npw == $rnpw)
            {
                ...
                if($respw)
                {
                    echo "<script> alert('Password Successfuly Changed.'); location.replace('./gallery.php') </script>"; 
                }
            ...
            {
                echo "<script> alert('Please Verify The Both Passwords are Same.'); location.replace('./gallery.php') </script>";
            }
        }
        else
        {
            echo "<script> alert('Please Verify The Current Password is Correct.'); location.replace('./gallery.php') </script>";
        }       
    }
