            ...
            <li class="nav-item">
                ...
                <div id="user" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="user_reg.php"><i class="bi bi-person-vcard-fill"></i> <span style="color:Red;">Account Create</span></a>
    ...
    <div class="row">
        <div class="col-md-6 border-right">
            <div class="p-3 py-5">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Mobile Number <span class="text-danger">*</span></label><input type="tel" minlength="10" maxlength="10" name="mobile" class="form-control" placeholder=" phone number" required="require" value="" autocomplete="off" onkeypress="funNumber()"></div>
                        <div class="col-md-12"><label class="labels">Email <span class="text-danger">*</span></label><input type="email" name="emailadd" class="form-control" placeholder="Email" required="require" value="" autocomplete="off"></div>
                        <div class="col-md-12"><label class="labels">NIC <span class="text-danger">*</span></label><input type="text" class="form-control" name="nic" minlength="10" maxlength="12" placeholder="NIC" value="" required="require" autocomplete="off" onkeypress="funNumber()"></div>
                        ...
                        <div class="col-md-12"><label class="labels">Date Of Birth <span class="text-danger">*</span></label><input type="date" name="dobd" class="form-control" placeholder="" value="" autocomplete="off" required="require"></div>
                    </div>
                <!-- </form> -->
            </div>
        </div>
        <div class="col-md-6">
            <div class="p-3 py-5">
                <!-- <form method="post"> -->
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="text-right">User Account Information</h4>
                </div>
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">User Name <span class="text-danger">*</span></label><input type="text" name="uname" class="form-control" placeholder="User Name" value="" autocomplete="off" required="require"></div>
                        <div class="col-md-12"><label class="labels">Password <span class="text-danger">*</span></label><input type="Password" name="pass" class="form-control" placeholder="Password" minlength="8" maxlength="16" value="" autocomplete="off" required="require"></div>
                        <div class="col-md-12"><label class="labels">Staff Id <span class="text-danger">*</span></label><input type="text" class="form-control" name="staffid" placeholder="Staff Id" value="" autocomplete="off" required="require"></div>
                    
                    <div class="col-md-12">
                        <label class="labels">User Type <span class="text-danger">*</span></label>

                        <select name="st_type" id="mysel" class="form-control" required="require">
                    ...
                    <div class="col-md-12"><label class="labels">User Image <span class="text-danger"></span></label><input type="file" class="form-control " accept="Image/*" name="img" placeholder="Staff Id" value="" autocomplete="off" ></div>
                </div>                     
                    <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="submit" name="save">Create Profile</button></div>
                </form>
            </div>
        </div>
    </div>
...
<?php
    if(isset($_POST['save']))
    {
        ...
        if($img == "")
        {
            if($gender =='Female')
            {
                $sql1="INSERT INTO user (First_Name,Last_Name,DOB,Gender,email,phone,username,password,usertype,index_or_staff,NIC,image,u_status) VALUES ('$firstnm','$lastnm','$dobd','$gender','$emailadd','$mobile','$uname','$encryptpw','$st_type','$staffid','$nic','female.png','1')";     
            }
            else
            {
                $sql1="INSERT INTO user (First_Name,Last_Name,DOB,Gender,email,phone,username,password,usertype,index_or_staff,NIC,image,u_status) VALUES ('$firstnm','$lastnm','$dobd','$gender','$emailadd','$mobile','$uname','$encryptpw','$st_type','$staffid','$nic','male.png','1')";
            }
        }
        if($img != "")
        {
            ...
            {
                echo "<script> alert('The File Size Is to Large...! Please Upload Lessthen 5MB.'); location.replace('./user_reg.php') </script>";
            }
        }
