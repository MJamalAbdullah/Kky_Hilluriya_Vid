        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="gallery.php">
                    ...
                    <span style="color:Yellow;">Gallery</span></a>
            </li>
        ...
        <div class="card-body">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label >Title :</label>
                    <input class="form-control" type="text" paceholder="Name" autocomplete="off" value="<?php echo $row['title'];?>" name="name" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <center><a href="gallery_img/<?php echo $row['image']; ?>"><img class="img-profile "  alt="Image" src="gallery_img/<?php echo $row['image']; ?>" width="200px" height="200px"></a><br></center>
                </div>
    ...
    if(isset($_POST['save']))
    {
        ...
        if(isset($_FILES["img"]))
        {
            ...
            if(!$file_size < 3072)
            {
                ...
                {
                    if($img_path ="gallery_img/".$row['image'])
                    {
                        unlink($img_path);
                        $img_data=$img;
                    }
                ...
                move_uploaded_file($_FILES["img"]["tmp_name"], "gallery_img/".$_FILES["img"]["name"]);

                $sql="UPDATE gallery SET title='$name',description='$desc',image='$img_data' WHERE id='$id';";
                $res=mysqli_query($con,$sql);

                if($res)
                {
                    echo "<script> alert('File Updated Successfully.'); location.replace('./gallery.php') </script>";
                }
                else
                {
